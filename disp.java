...
class disp extends JInternalFrame implements ActionListener
{
...
disp()
{
super("Display marks",true,true,true,true);
setSize(1000,500);
setLayout(null);
b1=new JButton("Show");
l1=new JLabel("Display Marks");
...
if(e.getSource()==b1 && cb1.getSelectedIndex()>0 && cb2.getSelectedIndex()>0 )
{
try{
int a=0;
if(jt!=null && jt2!=null)
...
String str3="select * from marks1 where dept_code='"+cb1.getSelectedItem()+"' and sem='"+cb2.getSelectedItem()+"'";
...
int j=0;
ResultSet rs4=stat.executeQuery(str3);
while(rs4.next())
{
